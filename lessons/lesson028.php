...
<head>
	...
	<title>Lección # 28 > JavaScript</title>
...
<div class="container-fluid">
	...
	<div class="jumbotron">
		<h1 class="text-center text-primary">Lección # 28 -- Formularios</h1>
	</div>
...
<script>
	$(document).ready(function() {
		$("#btn-send").click(comprobandoDatos);
	});

	function comprobandoDatos () {

		$(":text").each(function() {  // --- SELECCIONA TODOS LOS INPUT TIPO TEXT, Y POR C/U LANZA UN ALERT CON EL CONTENIDO --//
			alert($(this).val());
		});

		if ($("#rd-masculino").attr('checked')) {
			alert("Has Seleccionado Hombre");
		}

		else if ($("#rd-femenino").attr('checked')) {
			alert("Has Seleccionado Muhé");
		}
	}
</script>
